# Generated by Django 2.2.17 on 2020-11-26 12:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Department', to='employee.Company')),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('experiance', models.SmallIntegerField(default=0, help_text='Number of years of experiance')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='EmployeeHistory', to='employee.Employee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_permanent_address', models.BooleanField(default=False, help_text='Mark as permanent address')),
                ('address', address.models.AddressField(help_text='Address', null=True, on_delete=django.db.models.deletion.SET_NULL, to='address.Address')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='EmployeeAddress', to='employee.Employee')),
            ],
        ),
    ]
